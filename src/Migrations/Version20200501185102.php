 ...
 */
final class Version20200501185102 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE conference (id INT NOT NULL, city VARCHAR(255) NOT NULL, year VARCHAR(4) NOT NULL, is_itetnational BOOLEAN NOT NULL, PRIMARY KEY(id))');
